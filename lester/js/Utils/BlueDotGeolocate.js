...
(function() {
    ...
    window.BlueDot = function(map, options) {
        ...
        options.on.firstGeolocationUpdate = options.on.firstGeolocationUpdate || function(newLocation) {};
        ...
        self.updateLocation = function(pos) {
            ...
            if (self.marker === null) {
                ...
                //infoWindow.setContent("<div class='infoWindow'><h4>You are here.</h4></div>");
                //infoWindow.open(map);
